...
SOURCES =	main/main.c main/prompt.c \
			...
			builtins/builtins_helper6.c builtins/builtins_helper7.c builtins/echo.c builtins/cd.c \
			builtins/pwd.c builtins/export.c builtins/env.c builtins/exec_other.c \
