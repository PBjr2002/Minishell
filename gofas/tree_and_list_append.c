...
/*   Updated: 2024/09/12 18:13:30 by lmiguel-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*ft_redirect_branch_attach1(t_tree *tree, t_tree *new, int pipeline)
{
	if (tree->left == NULL)
	{
		new->parent = tree;
...
void	*ft_redirect_branch_attach2(t_tree *tree, t_tree *new, int pipeline)
{
	if (tree->right == NULL)
	{
		new->parent = tree;
...
t_tree	*ft_command_branch_attach_zero(t_tree *tree, t_tree *new, int pipeline)
{
	tree->parent = new;
	new->left = tree;
	return (new);
...
void	*ft_command_branch_attach1(t_tree *tree, t_tree *new, int pipeline)
{
	if (tree->left == NULL)
	{
		new->parent = tree;
...
void	*ft_command_branch_attach2(t_tree *tree, t_tree *new, int pipeline)
{
	if (tree->right == NULL)
	{
		new->parent = tree;
...
void	*ft_argument_branch_attach(t_tree *tree, t_tree *new, int pipeline)
{
	if (tree->right == NULL)
	{
		new->parent = tree;
